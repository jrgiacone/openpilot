...
def honda(started: bool, params: Params, CP: car.CarParams) -> bool:
  return started and CP.brand == "honda"
...
procs = [
  ...
  PythonProcess("hondasteerd", "openpilot.selfdrive.locationd.hondasteerd", honda),
